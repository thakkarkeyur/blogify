...
import { PlusIcon } from "@heroicons/react/solid";
import { logoutAction } from "../../../redux/slices/users/usersSlices";
import logo from '../../../img/BlogifyLogo.png';
              ...
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  ...
                  <Link
                    to="/create-post"
                    type="button"
                    className="font-nunito font-bold relative mr-4 inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm rounded-md text-white bg-red-400 hover:bg-gray-900 focus:outline-none"
                  >
                    <PlusIcon
                      className="-ml-1 mr-2 h-5 w-5"
                      aria-hidden="true"
                  ...
                  onClick = {() => dispatch(logoutAction())}
                    type="button"
                    className="font-nunito font-bold relative inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm rounded-md text-white bg-gray-900 hover:bg-red-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-indigo-500"
                  >
                    <LogoutIcon
                      className="-ml-1 mr-2 h-5 w-5"
                      aria-hidden="true"
