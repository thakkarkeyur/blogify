            ...
            <div className="flex justify-between h-16">
              ...
              <div className="flex items-center">
                <div className="flex-shrink-0 ">
                  <Link
                    to="/create-post"
                    className="font-nunito pr-3 relative inline-flex items-center mr-2 px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-400 hover:bg-gray-900 focus:outline-none"
                  >
                    <PlusIcon
                      className="-ml-1 mr-2 h-5 w-5"
                      aria-hidden="true"
                  ...
                  <button
                    onClick={ () => dispatch(logoutAction()) }
                    type="button"
                    className="font-nunito font-bold relative inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm rounded-md text-white bg-gray-900 hover:bg-red-400 focus:outline-none"
                  >
                    <LogoutIcon
                      className="-ml-1 mr-2 h-5 w-5"
                      aria-hidden="true"
