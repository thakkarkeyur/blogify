                ...
                <table className="min-w-full divide-y divide-gray-100">
                  <thead className="bg-gray-900">
                    <tr>
                      <th
                        scope="col"
                        className="px-6 py-3 text-left text-xs font-medium text-gray-1000 uppercase tracking-wider"
                      >
                        Author
                      </th>
                      <th
                  ...
                  <tbody>
                    {categoryList?.map(category => (
                      <tr className="bg-gray-900">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-1000">
                          {category.title}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-1000">
