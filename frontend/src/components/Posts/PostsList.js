...
export default function PostsList() {
  ...
  return (
    <>
      <section>
        <div className="py-20 bg-gray-100 min-h-screen radius-for-skewed">
          <div className="container mx-auto px-4">
            <div className="mb-16 flex flex-wrap items-center">
              <div className="w-full lg:w-1/2">
                ...
                <h2 className="text-4xl text-gray-900 lg:text-5xl font-bold font-heading">
                  Latest Post
                </h2>
              </div>
              <div className=" block text-right w-1/2">
                ...
                <button
                  ...
                  className="inline-block py-2 px-6 rounded-l-xl rounded-t-xl bg-red-400 hover:bg-gray-900 text-gray-100 font-bold leading-loose transition duration-200"
                >
                  View All Posts
                </button>
              </div>
            ...
            <div className="flex flex-wrap -mx-3">
              <div className="mb-8 lg:mb-0 w-full lg:w-1/4 px-3">
                <div className="py-4 px-6 bg-white shadow rounded">
                  <h4 className="mb-4 text-gray-900 font-bold uppercase">
                    Categories
                  </h4>
                  <ul>
                    {catLoading ? (
                      ...
                      categoryList?.map(category => (
                        <li>
                          <p
                            ...
                            className="block cursor-pointer py-2 px-3 mb-4 rounded text-gray-900 font-bold bg-gray-200"
                          >
                            {category?.title}
                          </p>
                        </li>
                    ...
                    >
                      <div className="mb-10  w-full lg:w-1/4 ">
                        ...
                        <div className="flex flex-row bg-gray-300  justify-center w-full  items-center ">
                          ...
                          <div className="flex flex-row justify-center items-center ml-4 mr-4 pb-2 pt-1">
                            <div>
                              <EyeIcon className="h-7 w-7  text-gray-900" />
                            </div>
                            <div className="pl-2 text-gray-900">
                              {post?.numViews}
                            </div>
