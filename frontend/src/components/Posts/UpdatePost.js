            ...
            <form onSubmit={formik.handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="rounded-lg appearance-none block w-full py-3 px-3 text-base text-center leading-tight text-gray-600 bg-transparent focus:bg-transparent  border border-gray-100 focus:border-gray-1000  focus:outline-none"
                  type="text"
                ></textarea>
                <div className="text-red-500">
              ...
              <div>
                {loading ? (
                  <button
                    disabled
                    className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gray-9000 "
                  >
                    Loading please wait...
                  </button>
                ) : (
