        ...
        <section className="py-20 2xl:py-40 bg-gray-800 overflow-hidden">
          <div className="container px-4 mx-auto">
            ...
            <div className="max-w-2xl mx-auto text-center">
              ...
              {/* User */}
              <div className="inline-flex pt-14 mb-14 items-center border-t border-gray-1000">
                <img
                ...
                <div className="text-left">
                  <h4 className="mb-1 text-2xl font-bold text-gray-100">
              ...
              <div class="max-w-xl mx-auto">
                <p class="mb-6 text-left  text-xl text-gray-100">
