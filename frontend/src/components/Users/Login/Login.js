...
//   if (userAuth) return <Redirect to="/posts" />;
//   return (
//     <>
...
//                       </h2>
//                     ) : null}
//                     <div className="flex items-center pl-6 mb-3 border border-gray-100 bg-white rounded-full">
...
//                     </div>
//                     <div className="flex items-center pl-6 mb-6 border border-gray-100 bg-white rounded-full">
//                       <span className="inline-block pr-3 border-r border-gray-100">
//                         <svg
//                           className="w-5 h-5"
//                           width="20"
...
//                       <button
//                         disabled
//                         className="py-4 w-full bg-gray-9000 text-white font-bold rounded-full transition duration-200"
//                       >
//                         Loading...
//                       </button>
//                     ) : (
...
const Login = () => {
  ...
  return (
    <>
      <section className="min-h-screen relative py-20 2xl:py-40 bg-gray-100 overflow-hidden">
        <div className="relative container px-4 mx-auto">
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-wrap items-center -mx-4">
              <div className="w-full lg:w-2/5 px-4">
                <div className="px-6 lg:px-16 py-12 lg:py-12 bg-white rounded-lg shadow-[0_0_10px_rgba(51,51,51,0.1)]">
                  {/* Form */}
                  <form onSubmit={formik.handleSubmit}>
                    <h3 className="mb-10 text-4xl text-gray-900 font-bold font-heading">
                      {/* Header */}
                      Login
                    </h3>
                    {/* Display Error */}
                    {serverErr || appErr ? (
                      <h2 className="mt-4 text-lg text-red-400">
                        {serverErr} - {appErr}
                      </h2>
                    ) : null}

                    {/* Email */}
                    <div className="flex items-center mt-3 mb-1 bg-gray-100 rounded">
                      <input
                        value={formik.values.email}
                        onChange={formik.handleChange("email")}
                        onBlur={formik.handleBlur("email")}
                        className="w-full pl-4 pr-6 py-3 placeholder-gray-400 bg-gray-100 rounded focus:bg-white focus:outline outline-red-400 outline-1"
                        type="email"
                        placeholder="Email"
                      />
                    </div>
                    ...
                    {loading ? (
                      <button
                        disabled
                        className="py-3 w-full bg-gray-900 text-white font-bold rounded transition duration-200"
                      >
                        Loading...
                      </button>
                    ) : (
                      <button
                        type="submit"
                        className="py-3 w-full bg-red-400 hover:bg-gray-900 text-white font-bold rounded transition duration-200"
                      >
                        Login
                      </button>
                    )}
              ...
              <div className="w-full lg:w-3/5 px-4 mb-16 lg:mb-0 order-first lg:order-last">
                <h2 className="leading-tight font-nunito font-extrabold text-gray-900 mb-8 text-center text-4xl lg:text-5xl font-heading">
                  Hello Again!
                </h2>
                <h2 className="leading-tight font-nunito font-extrabold mt-8 mb-8 text-5xl text-center font-heading text-gray-900">
